		...
		<div id="slider_content" class="content">
			<div class="content_div">
				<h1>
					...
					<span class="action-span1 action-span2">-创建子菜单</span>
				</h1>
				<form action="<%=path %>/admin/menu/addSubMenu" method="post" onsubmit="return checkForm();">
				...
				<div class="main-div">
					<table>
						...
						<tr>
							...
							<td><input id="menu_name" name="menu_name"  type="text"  class="input" /><span class="require-field">*</span></td>
						</tr>
						<tr>
							<td class="label">菜单url</td>
							<td><input id="url" name="url" type="text"  class="input" /><span class="require-field">*</span></td>
						</tr>
						<tr>
						    <td class="label">&nbsp;</td>
							<td>
