...
public class SensitivewordFilter {
	 ...
	 * 构造函数，初始化敏感词库
	 */
	public SensitivewordFilter(boolean hasFile,ISensitiveWordsService sensitiveWordService){
		sensitiveWordMap = new SensitiveWordInit().initKeyWord(hasFile,sensitiveWordService);
	}
	...
	public static void main(String[] args) {
		SensitivewordFilter filter = new SensitivewordFilter(true,null);
