...
<html>
	...
	<body>
		<div id="slider_content" class="content">
			<form id="feed_form"  action="<%=path %>/admin/feed/getBatchBackFeedLs" method="post">
				<div class="content_div">
					<h1>
						...
						<span class="action-span1 action-span2">-批处理反馈管理</span>
					</h1>
					<div class="form_div">
							...
							<tr>
								<c:forEach var="feed" items="${page.list }" varStatus="feedStatus">
									<tr>
										...
										<td> <a href="<%=path %>/admin/feed/toViewBatchFeed?id=${feed.id}" title="查看待处理反馈信息详情"><img src="<%=path %>/back/images/icon_view.gif" /></a></td>
									</tr>
								</c:forEach>
							</tr>
						</table>
